const Card = ({ card }) => {
  return (
    <div className="flex flex-col items-center max-w-sm sm:max-w-md mx-auto p-4 sm:p-6 bg-gradient-to-br from-yellow-100 via-white to-yellow-200 rounded-2xl shadow-2xl">
      {card.data.image && (
